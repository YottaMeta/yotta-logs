#!/usr/bin/env node
/**
 * @yottameta/yotta-logs cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-logs --agent <name>
 *   npx -y @yottameta/yotta-logs --dir <path>
 *   npx -y @yottameta/yotta-logs -g
 *   npx -y @yottameta/yotta-logs
 *   npx -y @yottameta/yotta-logs --list
 */
'use strict';
...
function usage() {
  console.log('yotta-logs installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-logs --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-logs --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-logs -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-logs                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-logs --list           List supported agent directories');
  console.log('');
  console.log('Options:');
